...
SECRET_KEY = 'django-insecure-($@zk5weer=r-3k(k*_r4w_oz09yp+c!(i8v!m5j42r5#6jt#s'
...
#         'rest_framework.authentication.SessionAuthentication',  # For login
...
#     'http://127.0.0.1:8000',  # Backend API URL
